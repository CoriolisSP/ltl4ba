...
SOLVER		= minisat/core/Solver.cc aaltasolver.cpp solver.cpp carsolver.cpp smtsolver.cpp libz3.so
...
ALLFILES     =	$(AUTOMATA) $(SOLVER) $(FORMULAFILES) $(PARSERFILES) $(UTILFILES) $(OTHER) main.cpp
...
release :   $(ALLFILES)
	    $(CC) $(FLAG) $(RELEASEFLAG) $(ALLFILES) -lz -o ltl4ba

debug :	$(ALLFILES)
	$(CC) $(FLAG) $(DEBUGFLAG) $(ALLFILES) -lz -o ltl4ba
